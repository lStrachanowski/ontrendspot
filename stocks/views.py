...
get_stock_mean_volume_value,percent_volume_change,get_stocks_mean_volumes, analyze_percent_changes, add_missing_stock_data
...
def index(request):
    analyze_percent_changes(30,100000,20)
